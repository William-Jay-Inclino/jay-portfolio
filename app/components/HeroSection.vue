    ...
    <div class="container mx-auto px-6">
      <div class="text-center">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center items-center animate-slide-up-delay-2">
          <a 
            href="#contact"
            @click="trackClick('hero_get_in_touch')"
          ...
          <a 
            href="#projects"
            @click="trackClick('hero_view_my_work')"
          ...
          <button 
            @click="isResumeModalOpen = true; trackClick('hero_view_resume')"
            class="px-8 py-3 bg-white dark:bg-gray-800 text-gray-900 dark:text-white border-2 border-gray-300 dark:border-gray-700 rounded-lg font-semibold hover:border-blue-600 dark:hover:border-blue-500 transform hover:scale-105 transition-all"
          >
            View Resume
          </button>
        <div class="flex justify-center space-x-6 mt-12 animate-fade-in-delay">
          ...
          <a href="https://www.linkedin.com/in/william-jay-inclino-02140022a/" target="_blank" @click="trackClick('hero_linkedin')" class="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-500 transform hover:scale-110 transition-all">
            <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
              <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
            </svg>
          </a>
          <a @click.prevent="scrollToSection('contact'); trackClick('hero_email')" href="#contact" class="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-500 transform hover:scale-110 transition-all">
